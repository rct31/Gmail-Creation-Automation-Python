# Account Creation Automation Script - Version 1.2.0
...
your_password = "x,nscldsj123..hnikjZ"
...
def fill_form(driver):
    try:
       ...
       # Create custom email
        ...
        time.sleep(2)
        if driver.find_elements(By.CSS_SELECTOR, "button span.VfPpkd-vQzf8d") :
...
fill_form(driver)
append_json("compte_google",your_username)
